...
def scale_and_remove_bg(source_path, factor, color, output_dir):
...
if __name__ == "__main__":
    SCALING_FACTOR = 16
    SOURCE_DIR = r"./Minecraft-Lora-Training/data_set/images_and_descriptions/"
    ...
    for (_,_,filenames) in walk(SOURCE_DIR):
        for filename in filenames:
            scale_and_remove_bg(SOURCE_DIR+filename, SCALING_FACTOR, BG_COLOR, OUTPUT_DIR)